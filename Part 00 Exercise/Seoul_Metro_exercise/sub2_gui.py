...
def command_args(num):
    ...
    if num == 1:
        # image.reduce(1)
        image=Image.open("line1up.png")
    elif num == 2:
        image=Image.open("line2up.png")
    elif num == 3:
        image=Image.open("line3up.png")
    elif num == 4:
        image=Image.open("line4up.png")
    elif num == 5:
        image=Image.open("line5up.png")
    elif num == 6:
        image=Image.open("line6up.png")
    elif num == 7:
        image=Image.open("line7up.png")
    elif num == 8:
        image=Image.open("line8up.png")
    elif num == 0:
        image=Image.open("init.png")
        # Image.close()
...
b26=tk.Button(frame2, text="8호선", background="#996CAC", width=20, command=lambda: command_args(8))
b26.pack(side="right", fill="y")
b27=tk.Button(frame2, text="7호선", background="#CD7C2F", width=20, command=lambda: command_args(7))
b27.pack(side="right", fill="y")
b28=tk.Button(frame2, text="6호선", background="#747F00", width=20, command=lambda: command_args(6))
b28.pack(side="right", fill="y")
b29=tk.Button(frame2, text="5호선", background="#EA545D", width=20, command=lambda: command_args(5))
